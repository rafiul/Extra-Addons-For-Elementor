...
class Product_Grid extends Widget_Base{
	...
	public function get_title() {
		return __( 'Product Grid', EAFE_TEXT_DOMAIN );
	}
    ...
    public function get_keywords() {
        return [ 'products', 'product', 'grid', 'woo','wc' ];
    }
	...
	*/
	...
	protected function general_controls() {
		...
		$this->add_control(
			'_ua_title_color', [
				...
				'selectors' => [
						'{{WRAPPER}} .ea .ua-product-title' => 'color: {{VALUE}};',
				],
				'default'=>'#111'
			]
        );
        $this->add_group_control(
			...
			[
					...
					'selector' => '{{WRAPPER}} .ea .ua-product-title',
			]
        );
        $this->add_responsive_control(
			'_ua_title_margin',
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .ea .ua-product-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'_ua_product_price_color', [
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
						'{{WRAPPER}} .ea .ua-product-price' => 'color: {{VALUE}};',
				],
                'separator' =>'before'
			]
        );
		...
		$this->add_group_control(
			...
			[
					...
					'selector' => '{{WRAPPER}} .ea .ua-product-price',
		...
		$this->add_control(
			'_ua_content_color', [
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
						'{{WRAPPER}} .ea .ua-product-details p' => 'color: {{VALUE}};',
				],
				'separator' => 'before'
			]
        );
		...
		$this->add_group_control(
			...
			[
					...
					'selector' => '{{WRAPPER}} .ea .ua-product-details p',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .ea .ua-product-details p' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .ea .ua-product-details' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'_ua_cat_color', [
				...
				'default'	=> '#a1a1a1',
				'selectors' => [
						'{{WRAPPER}} .ea .product-catagory' => 'color: {{VALUE}};',
				],
				'separator' => 'before'
			]
        );
		...
		$this->add_group_control(
			...
			[
					...
					'selector' => '{{WRAPPER}} .ea .product-catagory',
			]
		);
		$this->add_control(
			'_ua_front_title_tag',
	...
	protected function style_box_controls() {
		...
		$this->add_control(
			'_ua_box_bg', [
                ...
                'default'   => '#fff',
				'selectors' => [
						'{{WRAPPER}} .ea .product-grid' => 'background: {{VALUE}};',
				]
			]
        );
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .ea .product-grid' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ea .product-grid',
			]
		);
		$this->add_group_control(
		...
		$this->add_group_control(
			...
			[
				...
				'show_label'=>true,
				'selector' => '{{WRAPPER}} .ea .ua-product-bottom-details',
			]
		);
	...
	protected function sale_flash_controls() {
		...
		$this->add_control(
			'_ua_sale_flash_bg', [
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
						'{{WRAPPER}} .ua-badge' => 'background-color: {{VALUE}};',
				],
				'default'=>'#111'
			]
        );
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .ua-badge' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .ua-badge' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .ua-badge' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
    ...
    ?>
<div class="ea ua-col-<?php echo $col;?>">
